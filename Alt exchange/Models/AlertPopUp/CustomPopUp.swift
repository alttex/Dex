...
class CustomAlert: UIView, Modal {
    ...
    func initialize(title:String, image:UIImage){
        ...
        let dialogViewHeight = titleLabel.frame.height + 40 + separatorLineView.frame.height + 8 + imageView.frame.height + 8
        
        dialogView.frame.origin = CGPoint(x: 22, y: frame.height)
